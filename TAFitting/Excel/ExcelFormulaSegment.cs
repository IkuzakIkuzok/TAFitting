...
/// <param name="Value">The value associated with the segment, such as the literal text or token value.</param>
internal record struct ExcelFormulaSegment(ExcelFormulaSegmentType Type, ReadOnlyMemory<char> Value);
